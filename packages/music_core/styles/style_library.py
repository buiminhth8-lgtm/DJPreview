...
_TEMPLATES: list[StyleTemplateSpec] = [
    StyleTemplateSpec(
        ...
        default_tracks=[
            {"id": "melody", "role": "melody", "instrument": "piano", "pattern": "legato"},
            {"id": "piano", "role": "harmony", "instrument": "piano", "pattern": "arpeggio"},
            {"id": "strings", "role": "pad", "instrument": "strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_tracks=[
            ...
            {"id": "bass", "role": "bass", "instrument": "bass", "pattern": "roots"},
            {"id": "drums", "role": "drums", "instrument": "drums", "pattern": "lo-fi"},
            {"id": "pad", "role": "pad", "instrument": "strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_form=_default_form(),
        default_tracks=[
            {"id": "melody", "role": "melody", "instrument": "lead_synth", "pattern": "legato"},
            {"id": "piano", "role": "harmony", "instrument": "piano", "pattern": "block_chords"},
            {"id": "bass", "role": "bass", "instrument": "bass", "pattern": "roots"},
            {"id": "drums", "role": "drums", "instrument": "drums", "pattern": "pop"},
            {"id": "strings", "role": "pad", "instrument": "strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_tracks=[
            ...
            {"id": "strings", "role": "pad", "instrument": "strings", "pattern": "sustained_pad"},
            {"id": "pad", "role": "pad", "instrument": "synth_strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_form=_default_form(),
        default_tracks=[
            {"id": "melody", "role": "melody", "instrument": "lead_synth", "pattern": "staccato"},
            {"id": "piano", "role": "harmony", "instrument": "electric_guitar_clean", "pattern": "block_chords"},
            {"id": "bass", "role": "bass", "instrument": "synth_bass", "pattern": "roots"},
            {"id": "drums", "role": "drums", "instrument": "drums", "pattern": "rock"},
            {"id": "strings", "role": "pad", "instrument": "strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_form=_default_form(),
        default_tracks=[
            {"id": "melody", "role": "melody", "instrument": "pad_warm", "pattern": "sustained_pad"},
            {"id": "pad", "role": "pad", "instrument": "pad_warm", "pattern": "sustained_pad"},
            {"id": "strings", "role": "pad", "instrument": "synth_strings", "pattern": "sustained_pad"},
        ],
    ...
    StyleTemplateSpec(
        ...
        default_tracks=[
            {"id": "melody", "role": "melody", "instrument": "lead_synth", "pattern": "legato"},
            {"id": "piano", "role": "harmony", "instrument": "synth_pad", "pattern": "arpeggio"},
            {"id": "bass", "role": "bass", "instrument": "synth_bass", "pattern": "roots"},
            {"id": "drums", "role": "drums", "instrument": "drums", "pattern": "electronic"},
        ],
